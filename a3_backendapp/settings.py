"""
Django settings for a3_backendapp project.
...
ROOT_URLCONF = 'a3_backendapp.urls'
...
WSGI_APPLICATION = 'a3_backendapp.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'a3_backendapp/staticfiles'),
]